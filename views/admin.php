...
<div class="p-7" x-data="guestManager()">
    ...
    <div class="p-5 bg-white rounded-lg border border-pink-300">
        ...
        <div class="flex justify-between mb-2 gap-3">
            <h2 class="text-xl font-bold mb-4">Felicitaciones del evento: <?= $_ENV['EVENT_TITLE'] ?></h2>
            <div>
            ...
            <div class="flex gap-2 items-center">
                ...
                <div class="mt-3">
                    <input
                        type="text"
                        x-model="filter"
                        class="input border border-pink-300 rounded-full focus:outline-none focus:ring-4 focus:ring-pink-300 px-3 py-2 text-sm mb-3 transition"
                        placeholder="Buscar.."
                        required
                    >
                </div>
    ...
    >
        <div class="bg-white rounded-xl shadow-xl p-6 w-full max-w-md relative">
            ...
            <div>
                ...
                <tbody>
                    <tr>
                        <td>Total de registros: <span x-text="statsModal.stats.total"></span></td>
                    </tr>
                    <tr>
                        <td>Total de confirmados "Si": <span x-text="statsModal.stats.total_si"></span></td>
                    </tr>
                    <tr>
                        <td>Total de confirmados "No": <span x-text="statsModal.stats.total_no"></span></td>
                    </tr>
                    <tr>
                        <td>Total de confirmados "Tal vez": <span x-text="statsModal.stats.total_talvez"></span></td>
                    </tr>
                    <tr>
                        <td>Total de asistentes al evento (Considerando a los confirmados "Si" y sus +1): <span x-text="statsModal.stats.total_guests"></span></td>
                    </tr>
                </tbody>
                </table>
            </div>
